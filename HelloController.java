...
public class HelloController {
    ...
    protected void AssegnaPunto(){
        if(ospiti.isSelected()==true&&locali.isArmed()==false){
            puntisq1+=puntisq1;
           puntiOspiti.setText(String.valueOf(puntisq2));
           if(puntisq2==25){
               Punteggio.setText(String.valueOf(set));
               set++;
           }
           if(rotazione2){
               rotazione2=false;
        ...
        }else if(ospiti.isSelected()==false&&locali.isArmed()==true){
            puntisq2+=puntisq2;
            puntiLocali.setText(String.valueOf(puntisq1));
            if(puntisq1==25){
                Punteggio.setText(String.valueOf(set));
                set++;
            }
